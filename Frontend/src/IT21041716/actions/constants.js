export const authConstants ={
    ...
    UPDATE_FALIURE: 'UPDATE_FALIURE',
    UPDATE_SUCCESS: 'UPDATE_SUCCESS',
    GET_SELLER_REQUEST: 'GET_SELLER_REQUEST',
    GET_SELLER_FALIURE: 'GET_SELLER_FALIURE',
    GET_SELLER_SUCCESS: 'GET_SELLER_SUCCESS',
    UPDATE_DP_REQUEST: 'UPDATE_DP_REQUEST',
    UPDATE_DP_FALIURE: 'UPDATE_DP_FALIURE',
    UPDATE_DP_SUCCESS: 'UPDATE_DP_SUCCESS',
    UPDATE_GELLARY_REQUEST: 'UPDATE_GELLARY_REQUEST',
    UPDATE_GELLARY_FALIURE: 'UPDATE_GELLARY_FALIURE',
    UPDATE_GELLARY_SUCCESS: 'UPDATE_GELLARY_SUCCESS',
    UPDATE_PWD_REQUEST: 'UPDATE_PWD_REQUEST',
    UPDATE_PWD_FALIURE: 'UPDATE_PWD_FALIURE',
...
export const PostConstants = {
    ...
    GET_ALL_FALIURE: 'GET_ALL_FALIURE',
    ...
    GET_ONE_FALIURE: 'GET_ONE_FALIURE',
    GET_ONE_SUCCESS: 'GET_ONE_SUCCESS',
    CLIENT_REQUEST: 'CLIENT_REQUEST',
    CLIENT_FALIURE: 'CLIENT_FALIURE',
