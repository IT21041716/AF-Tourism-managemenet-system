...
console.log("Hi")
      ...
      else if (userName !== '' && birthday !== '' && country !== '' && email !== '' && country !== '' && password !== '' && tel_no !== '' && gender !== '') {
  ...
  const userLogin = (e) => {
    ...
    if (email === '') {
        ...
        const uid = axios.post("http://localhost:5000/user/usersignin",user).then((response)=>{
            ...
            <div style={{width:'80%'}}>
              ...
              <ul className="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                <li className="nav-item" role="presentation">
                    ...
                    style={{
                        background: "linear-gradient(90deg, #8B0000, #CD5C5C, #B22222,#CD5C5C, #8B0000)",
                        borderRadius: "20px",
                        color: "white",
                        fontWeight: "bold",
            ...
            <div className="tab-pane fade show active" id="pills-register" role="tabpanel" aria-labelledby="tab-register">
                ...
                <br/>
                                        <div className="row">
                                            ...
                                            <div className="form-outline mb-4">
                                                <input type="text" id="registerName" className="form-control" onChange={(e) => setUserName(e.target.value)} placeholder="ex: Ceylon Tours"/>
                                                <label className="form-label" htmlFor="registerName">Name</label>
                                            </div>
                                            </div>
                                            <div className="col-md-6">
                                            <div className="form-outline mb-4"> 
                                                <input type="date" id="registerUsername" className="form-control"  onChange={(e) => setBirthDay(e.target.value)}/>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                            <div className="form-outline mb-4">
                                                <input type="email" id="registerEmail" className="form-control" onChange={(e) => setEmail(e.target.value)} placeholder="ex: CeylonTours@gmail.com"/>
                                                <label className="form-label" htmlFor="registerEmail">Email</label>
                                            </div>
                                            </div>
                                            <div className="col-md-6">
                                            <div className="form-outline mb-4">
                                                <input type="password" id="registerPassword" className="form-control" onChange={(e) => setPassword(e.target.value)} placeholder="ex: CeylonX11"/>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                            <div className="form-outline mb-4">
                                                <input type="text" id="registerCountry" className="form-control" onChange={(e) => setCountry(e.target.value)} placeholder="ex: Sri Lanka"/>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                            <div className="form-outline mb-4">
                                                <input type="text" id="registerCountry" className="form-control" onChange={(e) => setTelNo(e.target.value)} placeholder="ex: +255 589 4225"/>
                                                <label className="form-label" htmlFor="registerCountry">Tel No</label>
                                            </div>
                                            </div>
                                            <div className="col-md-6">
                                        <div className="form-outline mb-4">
                                            <select className="form-select" id="registerGender" onChange={(e) => setBadge(e.target.value)}>
                                            <option selected disabled>Select Level</option>
                                            <option value="Silver">Level 01</option>
                                            <option value="Gold" disabled>Level 02</option>
                                            <option value="Platinum" disabled>Level 03</option>
                                            </select>
                                            <label className="form-label" htmlFor="registerGender">Badge</label>
                                        </div>
                                        </div>
                                        ...
                                        <div className="form-outline mb-4">
                                            <input type="file" id="registerFile" className="form-control"  onChange={(e) => { handleCatImg(e) }} />
                                            <label className="form-label" htmlFor="registerFile">Choose file</label>
                                        </div>
