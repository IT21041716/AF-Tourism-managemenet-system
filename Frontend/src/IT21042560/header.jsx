...
export default function Header() {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center' }}>
      ...
      <h3 style={{ fontFamily: 'Rockwell', marginTop:'-5px', marginLeft:'20px' }}>Ceylon Travel <br/>
      <h6 style={{ fontFamily: 'Brush Script MT', marginLeft:'10px', fontSize:'18px' }}>When You Need To Be Sure</h6>
      </h3>
